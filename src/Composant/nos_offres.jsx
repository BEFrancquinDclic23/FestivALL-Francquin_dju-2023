    ...
    <div className="nos_offres">
      <div className="section1">
        <div className="title">
          ...
          <div className="text">
            <h1>NOS OFFRES</h1>
            <p>Des promotion, des réductions et des offres spécialement pour vous.</p>
          </div>
        </div>
      </div>
      <div className="section2">
        <div className="case_left">
          <p>Une réduction de 5% sur chaque Offres si vous faite un abonnement Annuel de 30 euros</p>
          <Bout_plein name="S'abonnez"/>
        </div>
